...
if __name__ == "__main__":
    ...
    save_dir = r"./experiments/KNN/KNN_T1_A_UQ"
    torch.manual_seed(0)
    ...
    trial, n_neighbors, weights = 1, 3, 'uniform'   # optimal parameters!!!
    ...
    knn = pickle.load(open(os.path.join(exp_dir, 'model.sav'), 'rb'))
